...
/* Provide explicit prototypes for the platform functions to avoid implicit
 * declaration errors when compiling.
 */
int i2cWrite(unsigned char slave_addr, unsigned char reg_addr,
    unsigned char length, const unsigned char *data);
int i2cRead(unsigned char slave_addr, unsigned char reg_addr,
    unsigned char length, unsigned char *data);
